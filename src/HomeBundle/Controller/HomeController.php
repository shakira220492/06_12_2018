...
//        GUIPropertiesController.php
        ...
        $get_datamining_songs_home_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'get_datamining_songs_home_form');
        ...
        return $this->render('@Home/home/home.html.twig', array(
            ...
            'get_datamining_songs_home_form_ajax' => $get_datamining_songs_home_form_ajax->createView()
        ));
    }
